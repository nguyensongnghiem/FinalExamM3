...
<div class="container">
    ...
    <a href="/FinalExam?action=add" class="btn btn-primary mb-3">Thêm mới</a>    <%--   Sửa đường dẫn--%>
    <br>

    <%--    PHẦN TÌM KIẾM    --%>
    <form action="/FinalExam?action=search" method="post">           <%--   Sửa đường dẫn--%>
        ...
        <c:forEach var="medicalRecord" items="${recordDtos}" varStatus="status">
            <tr>
                ...
                <td>${medicalRecord.getPatientName()}</td>
                    ...
                    <%--   CHỨC NĂNG SỬA --%>
                <td>
                    <form action="/FinalExam?action=edit" method="get">                                 <%--   Sửa đường dẫn--%>
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="/FinalExam?action=delete" method="post">         <%--   Sửa đường dẫn--%>
